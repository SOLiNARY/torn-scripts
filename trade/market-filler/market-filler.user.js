...
(async function() {
    ...
    function AddFillButton(itemPriceElement){
        ...
        if (!isNaN(itemIdNum) && itemIdNum > 0){
            ...
            moneyGroup.prepend(favBtn, span);
            if (autoFillActive){
                enqueueFavouriteRow(wrapperParent);
            }
        } else {
